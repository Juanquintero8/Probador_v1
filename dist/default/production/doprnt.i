...
# 2 "<built-in>" 2
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\c90\\ctype.h" 1 3
...
# 2 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 3 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 4 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 7 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\c90\\float.h" 1 3
# 8 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c" 2
...
# 463 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
int
# 477 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
printf(const char * f, ...)
{
 va_list ap;
# 512 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
 char c;
# 521 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
 signed char prec;



 unsigned char flag;
# 540 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
 union {
  unsigned long vd;
  double integ;
 } tmpval;
 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 661 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
  switch(c = *f++) {

  case 0:
   goto alldone;
# 828 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
  default:
# 839 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
   continue;
...
# 1299 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
  {
# 1312 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
    val = (*(unsigned *)__va_arg((*(unsigned **)ap), (unsigned)0));
  }
# 1331 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
   for(c = 1 ; c != sizeof dpowers/sizeof dpowers[0] ; c++)
    if(val < dpowers[c])
     break;
# 1448 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
  {
# 1495 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
  }
  ...
  while(prec--) {
   ...
   {
# 1515 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
    c = (val / dpowers[(unsigned char)prec]) % 10 + '0';
# 1549 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
   }
   (putch(c) );
  }
